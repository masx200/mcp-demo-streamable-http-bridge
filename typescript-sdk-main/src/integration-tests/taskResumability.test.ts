...
describe("Transport resumability", () => {
  ...
  beforeEach(async () => {
    ...
    mcpServer.tool(
      ...
      {
        message: z.string().describe("Message to send").default(
          "Test notification",
        ),
      },
    ...
    mcpServer.tool(
      ...
      {
        count: z.number().describe("Number of notifications to send").default(
          10,
        ),
        interval: z.number().describe("Interval between notifications in ms")
          .default(50),
      },
