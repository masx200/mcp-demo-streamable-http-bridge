...
> [!IMPORTANT]
> This feature is designed for "simple" notifications that do not carry unique
> data in their parameters. To prevent silent data loss, debouncing is
> **automatically bypassed** for any notification that contains a `params`
